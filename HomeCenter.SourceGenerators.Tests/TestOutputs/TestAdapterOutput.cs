...
namespace HomeCenter.SourceGenerators.Tests
{
    ...
    {
        public TestAdapterProxy(HomeCenter.Abstractions.IValueConverter valueConverter, System.Collections.Generic.IList<string> list, HomeCenter.Abstractions.IMessageBroker messageBroker, Microsoft.Extensions.Logging.ILogger<HomeCenter.Actors.Core.DeviceActor> logger) : base(valueConverter, list)
        {
            MessageBroker = messageBroker;
            Logger = logger;
        }

        protected async override System.Threading.Tasks.Task ReceiveAsyncInternal(Proto.IContext context)
        {
        ...
        protected override async System.Threading.Tasks.Task OnStarted(Proto.IContext context)
        {
