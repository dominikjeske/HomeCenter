...
namespace HomeCenter.SourceGenerators
{
    internal class ProxyModel
    {
        ...
        public IEnumerable<ParameterDescriptor> ConstructorParameters { get; set; } = new List<ParameterDescriptor>();

        public IEnumerable<PropertyAssignDescriptor> InjectedProperties { get; set; } = new List<PropertyAssignDescriptor>();
